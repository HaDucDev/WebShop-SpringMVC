...
<c:url value="/admin/supplier/add" var="PCurl"></c:url>
<!DOCTYPE html>
<html>
<head>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form:form method="POST" role="form" action="${action}"
                                               enctype="multipart/form-data" modelAttribute="supplier">
                                        <div class="form-group">
                                            <label for="supplierName">Tên nhà cung cấp</label>
                                            <form:input class="form-control" path="supplierName"
                                                        placeholder="Nhập tên nhà cung cấp" name="supplierName"
                                                        id="supplierName"/>
                                        </div>
                                        <div class="form-group">
