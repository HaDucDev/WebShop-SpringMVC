    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-group"
                        ...
                        <button type="button" class="btn btn-primary" style="margin-right: 5px"
                                onclick="window.location='<c:url value="/admin/statistical-cate"/>'">Thống kê sản phẩm theo danh mục
                        </button>
                        <button type="button" class="btn btn-primary" style="margin-right: 5px"
                                onclick="window.location='<c:url value="/admin/statistical-product"/>'">Thống kê doanh thu theo từng sản phẩm
                        </button>
                        <button type="button" class="btn btn-primary"
                                onclick="window.location='<c:url value="/admin/statistical-product-month"/>'">Thống kê doang thu theo thời gian</button>
                    </div>
                </div>
                <div class="col-md-12">
                    <form action="">
                ...
                <div style="margin: auto"> <!--style="width:100%; height:500px; overflow:auto; margin: auto"-->
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <div style="height: 600px;width: 600px;margin: auto">
                            <canvas id="myChartProMonthStats"></canvas>
                        </div>
                    </div>
                </div>
